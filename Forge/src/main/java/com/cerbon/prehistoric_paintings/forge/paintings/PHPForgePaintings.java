package com.cerbon.prehistoric_paintings.forge.paintings;
...
public class PHPForgePaintings {
    public static DeferredRegister<PaintingVariant> PAINTINGS = DeferredRegister.create(ForgeRegistries.PAINTING_VARIANTS, PHPConstants.MOD_ID);
