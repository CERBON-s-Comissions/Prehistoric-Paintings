package com.cerbon.ml_template.neoforge.paintings;
...
public class PPNeoPaintings {
    public static DeferredRegister<PaintingVariant> PAINTINGS = DeferredRegister.create(BuiltInRegistries.PAINTING_VARIANT, ModConstants.MOD_ID);
